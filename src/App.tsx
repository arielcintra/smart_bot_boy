...
const App: React.FC = () => {
    ...
    return (
        <div style={{ fontFamily: 'Arial, sans-serif', display: 'flex', flexDirection: 'column', alignItems: 'center', height: '100vh', margin: 0, backgroundColor: '#f7f7f7' }}>
            ...
            <InputBoy onSend={handleSendText} placeholder="Ask me anything, my blessing..." />
            <InputBoy onSend={handleSearchAnswer} placeholder="I will search your question, my blessing..." />
