...
const SmartBoy: React.FC<SmartBoyProps> = ({ messages }) => {
    return (
        <div id="chatbox" style={{ width: '80%', maxWidth: '600px', height: '400px', border: '1px solid #ccc', borderRadius: '5px', padding: '10px', overflowY: 'auto', backgroundColor: 'white', boxShadow: '0 4px 10px rgba(0, 0, 0, 0.1)' }}>
